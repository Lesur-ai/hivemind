...
[![version](https://img.shields.io/badge/version-1.2.3-9CA3AF?style=flat-square)](#-license)
...
| `PROXY_URL`               | _(none)_          | Outbound HTTP proxy (e.g. `http://10.0.0.1:3128`). **Custom variable** (not `HTTP_PROXY`) — injected manually into boto3 (S3) and httpx (LLM). Not supported for `long`-tier connections. |
