...
assert.ok(summary.innerHTML.includes('Files total'));
assert.ok(summary.innerHTML.includes('>7<'));
assert.ok(summary.innerHTML.includes('Files deleted'));
assert.ok(summary.innerHTML.includes('>3<'));
assert.ok(summary.innerHTML.includes('Marker preserved'));
assert.ok(summary.innerHTML.includes('>false<'));
assert.ok(summary.innerHTML.includes('Access grants pending'));
assert.ok(summary.innerHTML.includes('>2<'));
assert.ok(summary.innerHTML.includes('Recovery retry safe'));
